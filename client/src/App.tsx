...
import LixeiraFinanceira from "@/pages/LixeiraFinanceira";
...
import ContabilidadeFiscal from "@/pages/ContabilidadeFiscal";
import ContabilidadeContabil from "@/pages/ContabilidadeContabil";
    ...
    <Switch>
      ...
      {!isAuthenticated ? (
        ...
        <>
          ...
          <Route path="/contabilidade-fiscal" component={ContabilidadeFiscal} />
          <Route path="/contabilidade-contabil" component={ContabilidadeContabil} />
          ...
          <Route path="/gestao-carteiras" component={GestaoCarteiras} />
      ...
      <Route path="/dashboard-financeiro" component={DashboardFinanceiro} />
          ...
          <Route path="/lixeira-financeira" component={LixeiraFinanceira} />
