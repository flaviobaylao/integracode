...
export const customers = pgTable("customers", {
  ...
  // Colunas garantidas no boot por ALTER ... IF NOT EXISTS (server/index.ts).
...
export const financialAccounts = pgTable("financial_accounts", {
  ...
  bbPixClientId: varchar("bb_pix_client_id"),
  bbPixClientSecret: varchar("bb_pix_client_secret"),
  bbPagamentosClientId: varchar("bb_pagamentos_client_id"),
  bbPagamentosClientSecret: varchar("bb_pagamentos_client_secret"),
  bbExtratoClientId: varchar("bb_extrato_client_id"),
  bbExtratoClientSecret: varchar("bb_extrato_client_secret"),
  bbWebhookConfigured: boolean("bb_webhook_configured").default(false).notNull(),
  bbConvenio: varchar("bb_convenio"),
  bbContrato: varchar("bb_contrato"),
  bbCarteira: varchar("bb_carteira"),
  bbVariacaoCarteira: varchar("bb_variacao_carteira"),
  bbJurosPercentual: decimal("bb_juros_percentual", { precision: 5, scale: 2 }),
  bbMultaPercentual: decimal("bb_multa_percentual", { precision: 5, scale: 2 }),
  bbDiasCompensacao: varchar("bb_dias_compensacao"),
  bbSenhaBoletos: varchar("bb_senha_boletos"),
  bbInstrucaoLinha1: varchar("bb_instrucao_linha1"),
  bbInstrucaoLinha2: varchar("bb_instrucao_linha2"),
  bbInstrucaoLinha3: varchar("bb_instrucao_linha3"),
  bbInstrucaoLinha4: varchar("bb_instrucao_linha4"),
  createdAt: timestamp("created_at").defaultNow().notNull(),
}, (table) => [
