  ...
  return (
    <Popover>
      <PopoverTrigger asChild>
        <button type="button" aria-label="Como este numero e calculado" className="shrink-0 inline-flex items-center justify-center h-4 w-4 rounded-full border border-gray-300 text-gray-400 text-[10px] font-bold leading-none hover:bg-gray-100 hover:text-gray-600">i</button>
      </PopoverTrigger>
      <PopoverContent align="end" side="bottom" className="w-72 text-xs leading-relaxed text-gray-700">{text}</PopoverContent>
    </Popover>
  );
}
...
export default function Dashboard() {
  ...
  return (
    <div className="space-y-6 p-4">
      ...
      {histView === "historico" ? <DashboardHistory /> : histView === "diario" ? <DailyHistory /> : histView === "termometro" ? <Termometro /> : <>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Card>
          <CardHeader className="pb-2"><div className="flex items-start justify-between gap-2"><CardTitle className="text-sm font-medium text-gray-500">Faturamento Efetivo (Semana)</CardTitle><InfoDot text="Faturamento efetivo: NF-e de VENDA autorizadas na semana vigente (nota fiscal real emitida). Considera apenas vendas, excluindo transferencia, remessa, cancelado, devolucao, amostra, bonificacao e troca. Fonte: notas fiscais (fiscal_invoices)." /></div></CardHeader>
        ...
        <Card>
          <CardHeader className="pb-2"><div className="flex items-start justify-between gap-2"><CardTitle className="text-sm font-medium text-gray-500">Faturamento Efetivo (Mês)</CardTitle><InfoDot text="Faturamento efetivo: NF-e de VENDA autorizadas no mes vigente (nota fiscal real). Considera apenas vendas, excluindo transferencia, remessa, cancelado, devolucao, amostra, bonificacao e troca, e sem os dados legados importados. Fonte: notas fiscais (fiscal_invoices)." /></div></CardHeader>
