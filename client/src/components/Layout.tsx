  ...
  const menuGroups: MenuGroup[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'fechamento-config', label: 'Regras do Fechamento', icon: 'fas fa-clipboard-check', available: canAccessUsers, badge: null },
        { id: 'fechamento-painel', label: 'Painel do Fechamento', icon: 'fas fa-chart-bar', available: canAccessReports, badge: null },
  ...
  const roleFilterItems = (items: MenuItem[]) => {
    return items.filter(item => {
      ...
      const roleOk = item.available
        && (!isMotorista || ['rota-entrega', 'entregas-do-dia'].includes(item.id))
