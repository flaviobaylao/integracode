    ...
    <Card className="border-l-4 border-l-rose-500"><CardContent className="py-3">
      ...
      {!open ? (
        ...
        <div className="mt-3 border-t border-dashed pt-3 space-y-2">
          ...
          <textarea className="w-full border rounded-lg px-3 py-2 text-sm bg-white text-gray-900 placeholder:text-gray-500" rows={2} placeholder="Escreva sua resposta ao admin…" value={text} onChange={(e) => setText(e.target.value)} />
                ...
                <Card key={c.id} className={`border-l-4 ${debtMode ? "border-l-amber-500" : "border-l-red-500"}`}><CardContent className="py-3">
                  ...
                  {!open ? (
                    ...
                    <div className="mt-3 border-t border-dashed pt-3">
                      ...
                      <textarea className="mt-1 w-full border rounded-lg px-3 py-2 text-sm bg-white text-gray-900 placeholder:text-gray-500" rows={2} placeholder={debtMode ? "Ex.: cliente vai quitar até sexta / negociado em 2x" : "Ex.: passei 17h e estava fechado"} value={draftNote} onChange={(e) => setDraftNote(e.target.value)} />
