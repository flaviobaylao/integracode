    ...
    try {
      ...
      const deliveries = await db.execute(sql`
        SELECT DISTINCT ON (b.id)
          ...
          COALESCE(c.vehicle_types, sc.vehicle_types, b.vehicle_types, '[]'::jsonb) as "vehicleTypes",
          ...
          COALESCE(c.delivery_weekdays, sc.delivery_weekdays, b.delivery_weekdays, '[]'::jsonb) as "deliveryWeekdays",
          COALESCE(c.delivery_time_slots, sc.delivery_time_slots, b.delivery_time_slots, '[]'::jsonb) as "deliveryTimeSlots",
          COALESCE(c.delivery_saturday_time_slots, sc.delivery_saturday_time_slots, b.delivery_saturday_time_slots, '[]'::jsonb) as "deliverySaturdayTimeSlots"
        FROM billings b
